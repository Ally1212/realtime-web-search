...
const freeNames={google_openserp:'OpenSERP · Google',google_wml_direct:'Google 轻量页面（直连）',google_wml:'Google 轻量页面（代理）',google_searxng:'SearXNG · Google',google_curl:'Google 标准页面',google_browser:'Google 浏览器'};
