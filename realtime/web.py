...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:  # noqa: N802
        ...
        if parsed.path == "/api/stats":
            ...
            payload["proxy_pools"] = {
                profile: cache.stats(profile) for profile in ("private", "public", "static")
            }
            self.send_json(payload)
            return
